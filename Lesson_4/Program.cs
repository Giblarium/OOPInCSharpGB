...
namespace Lesson_4
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int apartmentsEntrance = building.GetApartmentsEntrance();
            float heightFloors = building.GetHeightFloors();
            int apartmentsFloors = building.GetApartmentsFloors();
            ...
            apartmentsEntrance = building2.GetApartmentsEntrance();
            heightFloors = building2.GetHeightFloors();
            apartmentsFloors = building2.GetApartmentsFloors();
        }
